...
int main(int argc, char* argv[])
{
  ...
  printf(L"/// riftDriverPi V2.0.0 ///\n");
  
  // Check if program is started with terminal attached
  _Bool flgIsTerminal_l = isatty(STDIN_FILENO);
  if( flgIsTerminal_l)
  {
    printf(L"Terminal mode enabled. Hit 'return' to exit.\n");
  }
  printf(L"Waiting for device ...\n");
  ...
  while(1)
  {
    ...
    switch(state_e)
    {
      case state_Init_E: ///////////////////////////////////////////////
        ...
        printf(L"Configured non-blocking transfer\n");
      ...
      case state_Cleanup_E: ////////////////////////////////////////////
        ...
        printf(L"Connection lost. Waiting for device ...\n");
