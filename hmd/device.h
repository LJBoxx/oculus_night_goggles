...
#define hid_send_feature_report(dev, data, len) \
        (hid_send_feature_report)((dev), (unsigned char*)(data), (len))

#define hid_get_feature_report(dev, data, len) \
        (hid_get_feature_report)((dev), (unsigned char*)(data), (len))
